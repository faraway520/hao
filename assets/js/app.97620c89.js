...
! function(e) {
    ...
    o.push([103, 0]), n()
            ...
            var r = n(46),
                ...
                o = r(i) && r(i.createElement);
            e.exports = function(e) { return o ? i.createElement(e) : {} }
        }, function(e, t, n) { e.exports = n(178) }, function(e, t, n) {}, function(e, t, n) { Promise.all([n.e(0), n.e(21)]).then(n.t.bind(null, 179, 7)) }, function(e, t, n) {
            "use strict";
            var r = n(24);
            n.n(r).a
        }, function(e, t, n) {
                ...
                */
                ...
                r.prototype.init = function(e) {
                    if ("undefined" != typeof document) {
                        ...
                        try {
                            ...
                            var R = f.find(t.el, ".vempty");
                            t.nodata = { show: function(e) { return R.innerHTML = e || t.locale.tips.sofa, f.attr(R, "style", "display:block;"), t }, hide: function() { return f.attr(R, "style", "display:none;"), t } };
                            var L = f.create("div", "class", "vloading"),
                                D = f.find(t.el, ".vlist");
                            t.loading = { show: function(e) { var n = f.findAll(D, ".vcard"); return e ? D.insertBefore(L, n[0]) : D.appendChild(L), t.nodata.hide(), t }, hide: function() { var e = f.find(D, ".vloading"); return e && f.remove(e), 0 === f.findAll(D, ".vcard").length && t.nodata.show(), t } };
                            var B = f.find(t.el, ".vmark");
                            t.alert = {
                                show: function(e) {
                                    B.innerHTML = '<div class="valert txt-center"><div class="vtext">' + (e && e.text || 1) + '</div><div class="vbtns"></div></div>';
                                    var n = f.find(B, ".vbtns"),
                                    ...
                                    if (n.innerHTML = "" + r + (e && e.type && i), f.on("click", f.find(B, ".vcancel"), (function(e) { t.alert.hide() })), f.attr(B, "style", "display:block;"), e && e.type) {
                                        var o = f.find(B, ".vsure");
                                        f.on("click", o, (function(n) { t.alert.hide(), e.cb && e.cb() }))
                                    }
                                    return t
                                },
                                hide: function() { return f.attr(B, "style", "display:none;"), t }
                            }, t.bind(e)
                ...
                r.prototype.Q = function(e) {
                    ...
                    var R = f.find(t.el, ".vsubmit"),
                        ...
                        B = function() {
                            f.attr(R, "disabled", !0), t.loading.show(!0);
                            ...
                            e.setACL(D()), e.save().then((function(e) {
                                ...
                                try {
                                    ...
                                    v.mail && U({ username: v.nick, mail: v.mail }), N.at && N.rmail && t.notify && z({ username: N.at.replace("@", ""), mail: N.rmail }), f.removeAttr(R, "disabled"), t.loading.hide(), v.comment = "", E.comment.value = "", y(E.comment), f.attr(E.comment, "placeholder", t.placeholder), N = {}, t.preview.empty().hide()
                                } catch (e) { t.ErrorHandler(e) }
                    ...
                    f.on("click", R, L), f.on("keydown", document, (function(e) {
                        var n = (e = event || e).keyCode || e.which || e.charCode;
                        if ((e.ctrlKey || e.metaKey) && 13 === n && L(), 9 === n && "veditor" == (document.activeElement.id || "")) {
                            e.preventDefault();
            ...
            "undefined" != typeof self && self, e.exports = function(e) {
                        ...
                        var R = !{ toString: null }.propertyIsEnumerable("toString"),
                            ...
                            D = function(e, t) {
                                var n = L.length,
                                    ...
                                    o = "constructor";
                                for (A(e, o) && !g.contains(t, o) && t.push(o); n--;)(o = L[n]) in e && e[o] !== i[o] && !g.contains(t, o) && t.push(o)
                            };
                ...
                (function(t) {
                    ...
                    ! function(t, n) { e.exports = n() }(0, (function() {
                        ...
                        return L.prototype.then = o, L.all = function(e) { return new R(this, e).promise }, L.race = function(e) { var t = this; return new t(y(e) ? function(n, r) { for (var i = e.length, o = 0; o < i; o++) t.resolve(e[o]).then(n, r) } : function(e, t) { return t(new TypeError("You must pass an array to race.")) }) }, L.resolve = s, L.reject = function(e) { var t = new this(a); return d(t, e), t }, L._setScheduler = function(e) { w = e }, L._setAsap = function(e) { E = e }, L._asap = E, L.polyfill = function() {
                            var e = void 0;
                            if (void 0 !== t) e = t;
            ...
            $e.data = function(e, t, n) { return n ? je(e, t, n) : t && "function" != typeof t ? e : je(e, t) }, B.forEach((function(e) { $e[e] = Pe })), D.forEach((function(e) { $e[e + "s"] = Ne })), $e.watch = function(e, t, n, r) {
            ...
            function Ut(e, t, n, r, u, l) {
                return (Array.isArray(n) || a(n)) && (u = r, r = n, n = void 0), s(l) && (u = Mt),
                    function(e, t, n, r, a) {
                        ...
                        if ("string" == typeof t) {
                            var f;
                            l = e.$vnode && e.$vnode.ns || M.getTagNamespace(t), u = M.isReservedTag(t) ? new ve(M.parsePlatformTagName(t), n, r, void 0, void 0, e) : n && n.pre || !o(f = Le(e.$options, "components", t)) ? new ve(t, n, r, void 0, void 0, e) : Lt(f, n, e, r, t)
                        } else u = Lt(t, n, e, r);
            ...
            function kn(e) {
                ...
                e.extend = function(e) {
                    ...
                    return (s.prototype = Object.create(n.prototype)).constructor = s, s.cid = t++, s.options = Re(n.options, e), s.super = n, s.options.props && function(e) { var t = e.options.props; for (var n in t) mn(e.prototype, "_props", n) }(s), s.options.computed && function(e) { var t = e.options.computed; for (var n in t) _n(e.prototype, n, t[n]) }(s), s.extend = n.extend, s.mixin = n.mixin, s.use = n.use, D.forEach((function(e) { s[e] = n[e] })), o && (s.options.components[o] = s), s.superOptions = n.options, s.extendOptions = e, s.sealedOptions = T({}, s.options), i[r] = s, s
                }
            }
            ...
            function dr(e, t) {
                ...
                if (!(o(n) && !1 === n.Ctor.options.inheritAttrs || i(e.data.attrs) && i(t.data.attrs))) {
                    ...
                    for (r in (G || X) && u.value !== c.value && pr(a, "value", u.value), c) i(u[r]) && (Mn(r) ? a.removeAttributeNS(Bn, Un(r)) : Fn(r) || a.removeAttribute(r))
                }
            }
            ...
            function li(e, t) {
                ...
                if (!i(r) && !o(n._enterCb) && 1 === n.nodeType) {
                    ...
                    if (!O || w || "" === w) {
                        ...
                        })), I && I(n), L && (ri(n, S), ri(n, T), ni((function() { ii(n, S), B.cancelled || (ri(n, $), D || (hi(F) ? setTimeout(B, F) : oi(n, a, B))) }))), e.data.show && (t && t(), j && j(n, B)), L || D || B()
                    }
                }
            }
            ...
            function fi(e, t) {
                ...
                if (!o(n._leaveCb)) {
                    var s = r.css,
                        ...
                        w = v(c(y) ? y.leave : y);
                    0;
                    var E = n._leaveCb = R((function() { n.parentNode && n.parentNode._pending && (n.parentNode._pending[e.key] = null), _ && (ii(n, l), ii(n, f)), E.cancelled ? (_ && ii(n, u), m && m(n)) : (t(), p && p(n)), n._leaveCb = null }));
                    g ? g(C) : C()
                }
                    ...
                    if (!i(t)) {
                        ...
                        if (i(e)) l = !0, f(t, h);
                            ...
                            if (!d && ir(e, t)) A(e, t, h, null, null, a);
                                ...
                                if (d) {
                                    if (1 === e.nodeType && e.hasAttribute(L) && (e.removeAttribute(L), n = !0), s(n) && O(e, t, h)) return x(t, h, !0), e;
            ...
            var Li = {
                ...
                TransitionGroup: {
                    ...
                    updated: function() {
                        ...
                        e.length && this.hasMove(e[0].elm, t) && (e.forEach(Ni), e.forEach(Fi), e.forEach(Ri), this._reflow = document.body.offsetHeight, e.forEach((function(e) {
                            if (e.data.moved) {
                                var n = e.elm,
                                    r = n.style;
            ...
            ss.prototype.listen = function(e) { this.cb = e }, ss.prototype.onReady = function(e, t) { this.ready ? e() : (this.readyCbs.push(e), t && this.readyErrorCbs.push(t)) }, ss.prototype.onError = function(e) { this.errorCbs.push(e) }, ss.prototype.transitionTo = function(e, t, n) {
                ...
                var r = this,
                    i = this.current,
                    o = function(e) {!Mi(os, e) && Bi(e) && (r.errorCbs.length ? r.errorCbs.forEach((function(t) { t(e) })) : console.error(e)), n && n(e) };
                ...
                this.pending = e;
                var f = function(t, n) { if (r.pending !== e) return o(); try { t(e, i, (function(e) {!1 === e || Bi(e) ? (r.ensureURL(!0), o(e)) : "string" == typeof e || "object" == typeof e && ("string" == typeof e.path || "string" == typeof e.name) ? (o(), "object" == typeof e && e.replace ? r.replace(e) : r.push(e)) : n(e) })) } catch (e) { o(e) } };
                Zo(l, f, (function() {
                    var n = [];
                ...
                return t || (t = function(e) {
                    ...
                    for (h[Oc] = function() { void 0 !== n && (c.push(n), n = void 0) }, h[kc] = function() { void 0 === n ? n = r : n += r }, h[Sc] = function() { h[kc](), f++ }, h[Tc] = function() {
                            if (f > 0) f--, l = Ic, h[kc]();
                                ...
                                if (!1 === (n = Bc(n))) return !1;
                                h[Oc]()
                            }
                        }; null !== l;)
                        if (u++, "\\" !== (t = e[u]) || !d()) { if (i = Dc(t), (o = (a = Rc[l])[i] || a.else || Fc) === Fc) return; if (l = o[0], (s = h[o[1]]) && (r = void 0 === (r = o[2]) ? t : r, !1 === s())) return; if (l === Nc) return c }
                }(e)) && (this._cache[e] = t), t || []
            ...
            ***************************************************************************** */
            ...
            var Su;
            Yc([Ba({ type: [String, Function], required: !1, default: null })], Ou.prototype, "title", void 0), Yc([Ba({ type: [String, Number], required: !1, default: null })], Ou.prototype, "issueId", void 0), Yc([Ba({ type: Object, required: !1, default: () => ({}) })], Ou.prototype, "options", void 0), Yc([(Su = "vssue", $a((function(e, t) {
                var n = e.provide;
            ...
            class qu {
                ...
                async getIssue({ accessToken: e, issueId: t, issueTitle: n }) {
                    ...
                    if (e && (r.headers = { Authorization: `token ${e}` }), !t) {
                        ...
                        return i ? (this._issueNodeId = i.id, Bu(i)) : null
                    }
